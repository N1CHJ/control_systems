...
try:
    from .longitudinal_pd_controller import \
        HummingbirdControllerLonPD as ControllerLonPD
    __all__.append("ControllerLonPD")
except ImportError:
    pass

try:
    from .full_pd_controller import \
        HummingbirdControllerFullPD as ControllerFullPD
...
try:
    from .ssi_dist_obs_controller import \
        HummingbirdControllerSSIDO as ControllerSSIDO
